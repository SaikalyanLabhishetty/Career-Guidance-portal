    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span9">
               ...
               <center> <div class="alert alert-info" style="margin-top:40px">
<!--                    <button type="button" class="close" data-dismiss="alert">&times;</button>-->
<!--               <strong>Head Up!</strong>                        <a href="student_home.php">    click here to go student home</a>-->

STUDENT LOGIN

                </div></center>
              <div class="slider-wrapper theme-default" style="margin-left:170px">
