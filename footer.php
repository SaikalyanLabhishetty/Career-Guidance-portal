...
<div class="navbar  navbar-inverse">
    <div class="navbar-inner">
        <div class="footerindex" style="overflow:hidden;">
<!--            <img width="25" height="25" src="admin/img/chmsc.png">-->
                <center>
			<p style="font-size:20px;font-weight:10px; color: #387038;font-family:Segoe UI Symbol ">
            <marquee>Developed by:L.Sanjana(166B1A0569),N.Navatha(166B1A0587),M.Shivani(156B1A0558)</marquee>
</p>
			</center>
        </div>
        <!-- modal -->
        ...
        <div id="mission" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info"><strong> Book Reference Mission</strong></div>
                <p>
        ...
        <div id="vision" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <p> Excellence, Competence, and Educational Leaderhip in Science and Technology.</p>
                ...
                <div class="alert alert-info"><strong> Book Reference Vision</strong></div>

                To be able to prove to people that India also know how to cope up with the development in technology this will provide an easier way of teaching and a better form of learning.
