            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="span6">
                                <p style="font-size: 20px;font-weight:10px;text-align:center; color: #387038;font-family:Times New Roman ">ONLINE BOOKS REFERENCE</p>
...
<!--                                  <?php
                                    ...
                                    ?>
                                    -->
                                     <img  alt="ddddd" src="admin/<?php echo $teacher_row['location']; ?>"  class="img img-rounded" id="picture">
                                        &nbsp;
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="#logout" role="button"  data-toggle="modal"><i class="icon-signout icon-large"></i>&nbsp;Logout</a></li>
                                                                                  <li><a href="profile_teacher.php" role="button"  data-toggle=""><i class="icon-signout icon-large"></i>&nbsp;Profile</a></li>
